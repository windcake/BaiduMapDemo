package com.sound.haoshequ.autolayout.config;
...
import com.sound.haoshequ.autolayout.utils.L;
import com.sound.haoshequ.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg
{
    ...
    private void getMetaData(Context context)
    {
        ...
        try
        {
            ...
            {
                Log.i("aaaaa","mDesignWidth1:" + mDesignWidth);
                Log.i("aaaaa","mDesignHeight:" + mDesignHeight);
                mDesignWidth = (int) applicationInfo.metaData.get(KEY_DESIGN_WIDTH);
                Log.i("aaaaa","mDesignWidth2:" + mDesignWidth);
